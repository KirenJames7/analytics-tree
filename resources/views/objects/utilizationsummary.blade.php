...
<div id='scrollArea' class="body table-responsive clusterize clusterize-scroll">
    <table class="table table-bordered table-hover table-striped treetable" id="utilization-summary" style="">
        <caption>
            ...
            <button class='btn btn-default excol' id='utilization-summarycollapse' style='float:right'>Collapse All</button>
            <button class='btn btn-default excol' id='utilization-summaryexpand' style='float:right'>Expand All</button>
        </caption>
        <thead>
            <tr>
